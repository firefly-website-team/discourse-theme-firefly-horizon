...
const HighContextHeader = <template>
  <th scope="col" class="topic-list-data firefly-topic-list-header">
    <span class="firefly-topic-list-header__cell --topic">
      {{i18n (themePrefix "topic_list_header.topic")}}
    </span>
    <span class="firefly-topic-list-header__cell --replies">
      {{i18n (themePrefix "topic_list_header.replies")}}
    </span>
    <span class="firefly-topic-list-header__cell --views">
      {{i18n (themePrefix "topic_list_header.views")}}
    </span>
    <span class="firefly-topic-list-header__cell --activity">
      {{i18n (themePrefix "topic_list_header.activity")}}
    </span>
  </th>
</template>;
